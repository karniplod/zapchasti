...
BRAND_MASKS = {
    ...
    # 8450xxxxxx и старое 21080-6201014-00, которое после нормализации
    # превращается в длинную цифровую строку. Маска нарочно широкая
    "ВАЗ (LADA)": r"^(845[0-9]{7}|[0-9]{11,15})$",
    "LADA": r"^(845[0-9]{7}|[0-9]{11,15})$",
}
