...
class Settings(BaseSettings):
    ...
    # Потолок запросов в сутки. У Google бесплатны первые 100 в день,
    # дальше платно — а с привязанной картой «дальше» наступает молча.
    # Упёрлись в потолок: подсказка замолкает, приёмка работает как была
